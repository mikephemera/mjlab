...
_HIP_THIGH_JOINT_REGEX = r".*(FR|FL|RR|RL)_(hip|thigh)_joint.*"
_CALF_JOINT_REGEX = r".*(FR|FL|RR|RL)_calf_joint.*"
...
def unitree_go2_rough_env_cfg(
  ...
  # Set raycast sensor frame to Go2 base body.
  ...
  cfg.rewards["pose"].params["std_standing"] = {
    _HIP_THIGH_JOINT_REGEX: 0.05,
    _CALF_JOINT_REGEX: 0.1,
  }
  cfg.rewards["pose"].params["std_walking"] = {
    _HIP_THIGH_JOINT_REGEX: 0.3,
    _CALF_JOINT_REGEX: 0.6,
  }
